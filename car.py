...
class Car:
    def __init__(self, name, year, topspeed, acc, grip, drive, tyres, ride):
        self.name = name
        self.year = year
...
def dominates(car1, car2):
    if car1.topspeed >= car2.topspeed and car1.acc <= car2.acc and car1.grip >= car2.grip:
        if car1.drive == "4WD" or car2.drive == "FWD" or (car2.drive == "RWD" and car1.drive != "FWD"):
            if car1.tyres == "OFF" or car2.tyres == "PER" or car1.tyres == car2.tyres or (car1.tyres == "ALL" and car2.tyres == "STD"):
